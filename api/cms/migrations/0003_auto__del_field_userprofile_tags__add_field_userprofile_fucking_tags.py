...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cms_userprofile', 'tags_id')

        # Adding field 'UserProfile.fucking_tags'
        db.add_column(u'cms_userprofile', 'fucking_tags',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Tag'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.tags'
        db.add_column(u'cms_userprofile', 'tags',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Tag'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.fucking_tags'
        db.delete_column(u'cms_userprofile', 'fucking_tags_id')
    ...
    models = {
        ...
        u'cms.userprofile': {
            ...
            'fucking_tags': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cms.Tag']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
