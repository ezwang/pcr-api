...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'cms', ['Course'])

        # Adding model 'Summary'
        db.create_table(u'cms_summary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Course'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'cms', ['Summary'])

        # Adding model 'Review'
        db.create_table(u'cms_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Course'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'cms', ['Review'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cms_userprofile')

        # Removing M2M table for field tags on 'UserProfile'
        db.delete_table(db.shorten_name(u'cms_userprofile_tags'))

        # Deleting model 'Course'
        db.delete_table(u'cms_course')

        # Deleting model 'Summary'
        db.delete_table(u'cms_summary')

        # Deleting model 'Review'
        db.delete_table(u'cms_review')
    ...
    models = {
        ...
        u'cms.review': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cms.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cms.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['cms.Tag']", 'null': 'True', 'blank': 'True'}),
